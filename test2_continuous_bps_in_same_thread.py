...
thread2 = 0x1234582c	#CPU_index is 1

# hw_bp_addr sched __start_routine
hw_bps_list = [[0x123457ab, 1, thread1], [0x12345849, 2, thread2], [0x123457cb, 3, thread1], [0x123457ea, 4, thread1], [0x1234586c, 5, thread2], [0x1234580a, 6, thread1]]
